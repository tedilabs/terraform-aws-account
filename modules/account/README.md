...
| <a name="output_ses"></a> [ses](#output\_ses) | The account-level configurations of SES service.<br/>    `suppression_reasons` - A set of the reasons that email addresses will be automatically added to the suppression list for your account. |
